...
{
    return [UIImage imageNamed:@"k-popup-dismiss-butto"];
}
...
- (void)createDismissButton
{
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.dismissButton attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.topLayoutGuide attribute:NSLayoutAttributeBottom multiplier:1.0 constant:3*[[self class] kSideInset_dismissButton]]];
